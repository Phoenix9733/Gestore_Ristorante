...
public class ElencoTavoliCameriere {
	...
	public void visualizza() {
	    ...
	    back.addActionListener(new ActionListener() {
	    	public void actionPerformed(ActionEvent evento) {
	    	    ...
	    	    /**
	    	     * Se si clicca il tasto "si", viene chiuso il frame di controllo, viene chiuso l'elenco dei tavoli 
		...
		/**
		 * Viene poi chiamato il metodo grazie al quale i tavoli con i relativi stati vengono inseriti sul pannello centrale.
		 */
		popolaPannello();
	...
	public void popolaPannello() {
		...
		for (int i = 0; i < nomitavoli.length; i++) {
		    ...
		    /**
    		 * Cliccando su un tavolo viene creato un nuovo frame dato dalla classe TavoloSingolo, 
    		 * dove ci si porta dietro il numero del tavolo su cui ho cliccato.
    		 */
